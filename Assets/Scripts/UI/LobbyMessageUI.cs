...
public class LobbyMessageUI : MonoBehaviour
{
    ...
    {
        ShowMessage("Failed to join the lobby. Please try again!!!");
    }

    private void KitchenGameLobby_OnQuickJoinFailed(object sender, EventArgs e)
    {
        ShowMessage("Could not find a lobby to join. Please try again!!!");
    }
    ...
    private void KitchenGameMultiplayer_OnFailToJoinGame(object sender, EventArgs e)
    {
        ...
        {
            ShowMessage("Failed to join the game. Please try again!!!");
        }
        else
        {
